package org.firstinspires.ftc.teamcode.auto.Sample;//package org.firstinspires.ftc.teamcode.auto.Sample;
//
...
//
//@Config
//@Autonomous (name = "Safe(2+4)",group = "Autonomous")
//public class SampleSafe6 extends LinearOpMode {
//
...
//                .stopAndAdd(() -> new sampleDropPose(outake_ss, elevator_ss))
//                .waitSeconds(0.5)
//                .strafeToLinearHeading(new Vector2d(-57.5, -56.5), Math.toRadians(15))
//                .stopAndAdd(() -> new sampleDrop(outake_ss))
//
//                //TODO 2nd Preload Picking
//                .afterTime(0.8, () -> new sampleIntake(intake_ss, outake_ss, elevator_ss, "Preloadd2"))
...
//                .afterTime(0.01,samplePreTransfer.samplePreTransfer(intake_ss, outake_ss, elevator_ss))
//                .afterTime(1.4, () -> new sampleDropPose(intake_ss, outake_ss, elevator_ss, 'P'))
//                .strafeToLinearHeading(new Vector2d(-63, -51.5), Math.toRadians(65))
//                .stopAndAdd(() -> new sampleDrop(outake_ss));
//
...
//                .waitSeconds(0.7)
//                .afterTime(0.01,()-> new sampleIntake(intake_ss,elevator_ss))
//                .strafeToLinearHeading(new Vector2d(-64, -50), Math.toRadians(75))
//                .stopAndAdd(() -> new sampleDrop(outake_ss));
//
...
//                .afterTime(2.5,()->new  sampleIntake(intake_ss, outake_ss, elevator_ss))
//                .splineToLinearHeading(new Pose2d(-22, -4,Math.toRadians(0)), Math.toRadians(-20))
////                .stopAndAdd(()->new  sampleIntake(intake_ss, outake_ss, elevator_ss, 3))
//                .waitSeconds(0.5);
//
//        //TODO - 4th Sample Droppong
//        TrajectoryActionBuilder trajectoryAction9 = trajectoryAction8.endTrajectory().fresh()
//                .afterTime(0.01, () -> new sampleDropPose(intake_ss, outake_ss, elevator_ss,"LastDrop", 'P'))
//                .setReversed(true)
//                .splineToLinearHeading(new Pose2d(-61.5, -50.5,Math.toRadians(50)), Math.toRadians(-120))
//                .stopAndAdd(() -> new sampleDrop(outake_ss));
//
//
...
////                );
//                state = 2;
//            } else if (timer.seconds() > 0.5 && timer.seconds() < 4 && state != 1) {
//                Actions.runBlocking(new SequentialAction(
